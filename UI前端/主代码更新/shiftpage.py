...
class PageSwitchHandler:
    ...
    def connection_button(self):
        ...
        self.ui.wr_class1.clicked.connect(self.on_wr_class1_clicked)
        self.ui.wr_class2.clicked.connect(self.on_wr_class2_clicked)
        self.ui.wr_class3.clicked.connect(self.on_wr_class3_clicked)
        self.ui.wr_class4.clicked.connect(self.on_wr_class4_clicked)
        self.ui.wr_class5.clicked.connect(self.on_wr_class5_clicked)
        self.ui.wr_class6.clicked.connect(self.on_wr_class6_clicked)
        self.ui.wr_class7.clicked.connect(self.on_wr_class7_clicked)

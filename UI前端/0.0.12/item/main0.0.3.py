...
class MainWindow(QMainWindow):
    ...
    def request_question(self):
        self.ui.Bt_A_ex.setStyleSheet('')
        self.ui.Bt_B_ex.setStyleSheet('')
        self.ui.Bt_C_ex.setStyleSheet('')
        self.ui.Bt_D_ex.setStyleSheet('')
        ...
        # question = response.json()[1]["question_description"]   # 题目
        # answer = "Bt_A"     # 答案
        # self.ui.test_wrong.setText(question)
        # self.ui.Bt_A_ex.setText(response.json()[1]["answer_A"])
        # self.ui.Bt_B_ex.setText(response.json()[1]["answer_B"])
        # self.ui.Bt_C_ex.setText(response.json()[1]["answer_C"])
        # self.ui.Bt_D_ex.setText(response.json()[1]["answer_D"])
